...
usb_status_t USB_HostInit(uint8_t controllerId, usb_host_handle *hostHandle, host_callback_t callbackFn)
{
    ...
    PRINTF("  USB_HostInit: Getting host instance...\r\n");
    hostInstance = USB_HostGetInstance(); /* get one host instance */
    if (hostInstance == NULL)
    {
        PRINTF("  USB_HostInit: Failed getting host instance.\r\n");
        return kStatus_USB_InvalidHandle;
    }

    PRINTF("  USB_HostInit: Getting controller interface...\r\n");
    ...
    {
        PRINTF("  USB_HostInit: Controller interface not found.\r\n");
        USB_HostReleaseInstance(hostInstance);
        return kStatus_USB_ControllerNotFound;
    }

    PRINTF("  USB_HostInit: Checking interface callbacks...\r\n");
    ...
    {
        PRINTF("  USB_HostInit: Callback check failed.\r\n");
        return kStatus_USB_Error;
    }

    PRINTF("  USB_HostInit: Creating mutex...\r\n");
    /* HOST instance init*/
    ...
    {
        PRINTF("  USB_HostInit: Mutex creation failed.\r\n");
        USB_HostReleaseInstance(hostInstance);
        return kStatus_USB_Error;
    }

    PRINTF("  USB_HostInit: Initializing transfer list...\r\n");
    ...
    PRINTF("  USB_HostInit: Creating controller...\r\n");
    ...
    {
        PRINTF("  USB_HostInit: Controller create failed: %d\r\n", status);
